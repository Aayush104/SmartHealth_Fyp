...
//         console.log("List hyo ho",response);
...
//                   onClick={appointment.isButtonEnabled ? HandleJoinAppointment(appointment.meetingId) : undefined}
//                 >
//                   Join Appointment
//                 </button>
//               </div>
              ...
              <div className="bg-white p-4 rounded-lg shadow flex items-center justify-between" key={index}>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-medium">Dr. {appointment.doctorName}</p>
                    <p className="text-gray-600 text-sm">
                      {appointment.appointmentDate.split("T")[0]}, {formatTime(appointment.slot)} -{" "}
                ...
                <button
                  className={`px-4 py-2 rounded ${
                    appointment.isButtonEnabled ? "bg-sky-500 text-white" : "bg-gray-300 text-gray-600"
                  }`}
                  disabled={!appointment.isButtonEnabled}
