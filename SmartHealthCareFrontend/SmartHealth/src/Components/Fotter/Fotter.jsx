...
const Footer = () => {
  return (
    <footer className='py-8 px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-8 bg-primary text-white mt-20 overflow-hidden custom-footer '>
      <div>
      ...
      <div className='mt-8 lg:mt-0 lg:mx-auto'>
        <h2 className='text-3xl flex font-medium mb-6'>Quick Links</h2>
        <ul>
      ...
      <div className='mt-8 lg:mt-0'>
        <h2 className='text-3xl flex font-medium mb-6'>Have a Question?</h2>
      ...
      <div className='text-center pb-8 xl:col-span-4'>
